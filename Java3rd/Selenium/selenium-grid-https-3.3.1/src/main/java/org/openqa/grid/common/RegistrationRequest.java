...
public class RegistrationRequest {
  ...
  public static RegistrationRequest build(GridNodeConfiguration configuration, String name, String description) {
    ...
    if (pendingConfiguration.protocol != null) {
        pendingRequest.configuration.protocol = pendingConfiguration.protocol;
      }
  ...
  private void fixUpProtocal() {
	  if(configuration.keyStorePath != null) {
