...
public class SelfRegisteringRemote {
  ...
  public URL getRemoteURL() {
	String protocol = registrationRequest.getConfiguration().protocol;
  ...
  private void registerToHub(boolean checkPresenceFirst) {
    if (!checkPresenceFirst || !isAlreadyRegistered(registrationRequest)) {
      String tmp =
    		  registrationRequest.getConfiguration().getHubProtocol() + "://" + registrationRequest.getConfiguration().getHubHost() + ":"
      ...
      try {
        ...
        HttpHost host = new HttpHost(registration.getHost(), registration.getPort(), registration.getProtocol());
  ...
  private GridHubConfiguration getHubConfiguration() throws Exception {
    ...
    HttpHost host = new HttpHost(api.getHost(), api.getPort(), api.getProtocol());
  ...
  private boolean isAlreadyRegistered(RegistrationRequest node) {
    ...
    try {
      String tmp =
    		  registrationRequest.getConfiguration().getHubProtocol() + "://" + node.getConfiguration().getHubHost() + ":"
