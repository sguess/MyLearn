...
//            mergeImage();
    ...
    private static void splitImage() throws Exception {
        String originalImg = "S:\\myLearn\\WorkspaceIdeaObj\\20180830tmp\\res\\a.jpg";
        ...
        for (int i = 0; i < imgs.length; i++) {
            ImageIO.write(imgs[i], "jpg", new File("S:\\myLearn\\WorkspaceIdeaObj\\20180830tmp\\res\\output" + i + ".jpg"));
        }
